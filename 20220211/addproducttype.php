      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
			...
			<form action="producttypeadd.php" name="frm3" id="frm3" method="post">
                ...
                <div class="card-body">
					  <div class="form-group">
						...
						<div class="row align-items-center">
						  <div class="col-auto">
							<input type="text" name="product_type" id="product_type" class="form-control" value="">
						  </div>
						</div>
					  </div>					
					  <div class="form-group">
						...
						<div class="row align-items-center">
						  <div class="col-auto">
							<input type="text" name="producttype_name" id="producttype_name" class="form-control" value="">
						  </div>
						</div>
					  </div>
