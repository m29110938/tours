            ...
            <div class="card-body">
              <div class="table-responsive">
				...
				//if ($act == 'Qry') {
					...
					$sql = "SELECT a.*,b.producttype_name FROM product as a ";
					$sql = $sql." inner join ( select pid,producttype_name from producttype) as b ON a.pid= b.pid ";
					...
					if ($producttype != "") {	
						$sql = $sql." and a.pid = ".$producttype."";
					}					
			
					$sql = $sql." order by a.pid,a.product_no ";
					//echo $sql;
					//exit;
