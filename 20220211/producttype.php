...
<body id="page-top">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
		...
		<div id="collapseUtilities1" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
		  <div class="bg-white py-2 collapse-inner rounded">
			<a class="collapse-item active" href="producttype.php">商品分類</a>
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3">
			...
			<h1 class="h5 mb-0 text-gray-800">商品分類設定</h1>
		...
		<?php
			...
			$producttypename = isset($_POST['producttype_name']) ? $_POST['producttype_name'] : '';
			$producttypename  = mysqli_real_escape_string($link,$producttypename);
        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
				  ...
				  <div class="card-body">
				    <form action="producttype.php" method="Post" name='frm1' id='frm1' class="card">
					...
					<div class="row">
						<div class="col-md-6 col-lg-2">
						  <div class="form-group">
							...
							<div class="row align-items-center">
							  <div class="col-auto">
								<input type="text" id="product_type" name="product_type" class="form-control w-12" value="<?php echo $producttype; ?>">
							  </div>
							</div>
						  </div>	
						</div>
						<div class="col-md-6 col-lg-2">
						  <div class="form-group">
							...
							<div class="row align-items-center">
							  <div class="col-auto">
								<input type="text" id="producttype_name" name="producttype_name" class="form-control w-12" value="<?php echo $producttypename; ?>">
							  </div>
							</div>
						  </div>	
						</div>	
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">商品分類列表</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
				...
				//if ($act == 'Qry') {
					...
					$sql = "SELECT * FROM producttype where producttype_trash=0 ";

					if ($producttype != "") {	
						$sql = $sql." and product_type like '%".$producttype."%'";
					}
					if ($producttypename != "") {	
						$sql = $sql." and producttype_name like '%".$producttypename."%'";
					}
			
					$sql = $sql." order by product_type,producttype_name asc ";
					//echo $sql;
					//exit;
					$idx = 0;
  ...
  <SCRIPT LANGUAGE=javascript>
	...
	function ExportLog()
	{
		document.all.downloadlog.src="storeype.php";
	}	
	function GoAddUser()
	{	
		document.getElementById("act").value = 'Add';
		document.frm1.action="addproducttype.php";
		//self.location.replace("addproducttype.php");
	...
	{	
		...
		//alert(id);
		document.frm1.action="editproducttype.php";	
		//self.location.replace("editproducttype.php");	
		document.frm1.submit();
	}
	function GoDel(id)
	{	
		if (confirm('確定要刪除這筆資料嗎?')) {
			...
			document.getElementById("tid").value = id;
			//alert(id);
			document.frm1.action="producttypedel.php";	
			document.frm1.submit();
		}
	}	
	function Logout(){
