...
<body id="page-top">
  ...
  <div id="wrapper">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
			...
			<form action="couponadd.php" name="frm3" id="frm3" method="post">
			<input type="hidden" name="act" id="act"  value="<?php echo $act;?>"/>				  
			  
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">新增優惠券</h6>
                </div>
                <div class="card-body">
				<table width="100%">
				<tr >
						...
						<div class="row align-items-center">
						  <div class="col-auto">
								<select name="coupon_type" id="coupon_type" class="form-control custom-select" onchange="check_type()">
								  ...
								  <option value="4">平台優惠券</option>
								  <option value="5">平台生日禮</option>
								  <!-- <option value="5">平台生日禮</option> -->
								  <option value="6">平台註冊禮</option>
								  <option value="7">平台AR優惠券</option>
					...
					<td width="40%" valign="top">
					  ...
					  <div class="form-group">
						...
						<div class="row align-items-center">
							<div class="col-auto">
								<!-- <input type="hidden" name="coupon_storeid" id="coupon_storeid" class="form-control"/> -->
	...
	function check_type(){
		...
		if (document.getElementById("coupon_type").value == "6") {
