      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
			...
			<form action="hairstylistadd.php" name="frm3" id="frm3" method="post">
			<input type="hidden" name="act" id="act"  value="<?php echo $act;?>"/>				  
                ...
                <div class="card-body">
					  ...
					  <div class="form-group">
						...
						<div class="row align-items-center">
						  <div class="col-auto">
							<input type="text" name="nick_name" id="nick_name" class="form-control" value="">
						  </div>
						</div>
					  </div>				
					  ...
					  <div class="form-group">
						...
						<div class="row align-items-center">
						  <div class="col-auto">
							<!--<input type="text" name="hairstylist_date" id="hairstylist_date" class="form-control" value="">-->
							<input class="text-input small-input" type="date" name="hairstylist_date" id="hairstylist_date" value="<?=$hairstylist_date;?>" />
						  </div>
						</div>
					  </div>
