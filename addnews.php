      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
			...
			<form action="newsadd.php" name="frm3" id="frm3" method="post">
			<input type="hidden" name="act" id="act"  value="<?php echo $act;?>"/>				  
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">新增最新消息</h6>
                </div>
                <div class="card-body">
				<table width="100%">
				<tr >
					...
					<td width="30%">
					  <div class="form-group">
						...
						<div class="row align-items-center">
						  <div class="col-auto">
							<input type="text" name="news_subject" id="news_subject" class="form-control" value="">
						  </div>
						</div>
					  </div>	
					  ...
					  <div class="form-group">
						...
						<div class="row align-items-center">
						  <div class="col-auto">
							<textarea id="news_descript" name="news_descript" rows="4" cols="50"></textarea>	
						  </div>
						</div>
					  </div>
					  <div class="form-group">
						...
						<div class="row align-items-center">
						  <div class="col-auto">
							  <input class="text-input small-input" type="date" name="news_date" id="news_date" value="" />
						  </div>
						</div>
					  </div>		
