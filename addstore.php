...
<body id="page-top">
  ...
  <div id="wrapper">
	...
	?>
	<script>
		document.querySelector('#storephp').classList.add('active');
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
			...
			<form action="storeadd.php" name="frm3" id="frm3" method="post">
			<input type="hidden" name="act" id="act"  value="<?php echo $act;?>"/>				  
			  
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">新增店家資料</h6>
                </div>
                <div class="card-body">
