...
<body id="page-top">
  ...
  <div id="wrapper">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3">
			...
			<h1 class="h5 mb-0 text-gray-800">類別設定</h1>
          <!-- Topbar Navbar -->
        ...
        <div class="container-fluid">
          ...
          <div class="row">
			...
			<form action="storetypeadd.php" name="frm3" id="frm3" method="post">
			<input type="hidden" name="act" id="act"  value="<?php echo $act;?>"/>
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">新增類別設定</h6>
                </div>
                <div class="card-body">
					  <div class="form-group">
						...
						<div class="row align-items-center">
						  <div class="col-auto">
							<input type="text" name="store_type" id="store_type" class="form-control" value="">
						  </div>
						</div>
					  </div>					
					  <div class="form-group">
						...
						<div class="row align-items-center">
						  <div class="col-auto">
							<input type="text" name="storetype_name" id="storetype_name" class="form-control" value="">
						  </div>
						</div>
					  </div>
	...
	function Save_User(){
		...
		if (!checkString(document.all.store_type,"請輸入商店類別代碼!"))	return false;
		if (!checkString(document.all.storetype_name,"請輸入商店類別名稱!"))	return false;
	...
	function GoAccount()
	{
			self.location.replace("storetype.php");
	}
	function Logout(){
		//alert("登出系統!");
