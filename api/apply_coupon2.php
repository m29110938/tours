						...
						if (mysqli_num_rows($result3) > 0){
							...
							//if ($coupon_storeid == $sid){
								try {
									...
									$sql=$sql." select $coupon_storeid,$mid,'$member_name',NOW(),coupon_no,coupon_name,0 from mycoupon where using_flag=0 and coupon_no='$coupon_no' ;";
									...
									if ($rvalue > 0) {
										...
										Save_Log($link,$member_id,$member_name,$coupon_storeid,'Apply coupon',4);
