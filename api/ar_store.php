			...
			if ($result = mysqli_query($link, $sql)){
				if (mysqli_num_rows($result) > 0){
					...
					try {
						...
						$sql2 = "SELECT `rid`, `qid`, `aid`, `store_name`, `store_address` FROM arstore where store_trash=0 ";
						//$sql2 = $sql2." and coupon_enddate > NOW()";
						if ($qid != "") {	
							$sql2 = $sql2." and qid=".$qid."";
						}
						if ($aid != "") {	
							$sql2 = $sql2." and aid=".$aid."";
						}					
						$sql2 = $sql2." order by qid,aid,rid";
//echo $sql2;
						...
						if ($result2 = mysqli_query($link, $sql2)){
							if (mysqli_num_rows($result2) > 0){
								...
								$data["status"]="false";
								$data["code"]="0x0201";
								$data["responseMessage"]="This is no ar store data!";									
							}
						}else{
