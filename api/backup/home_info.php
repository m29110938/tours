			...
			if ($result = mysqli_query($link, $sql)){
				if (mysqli_num_rows($result) > 0){
					...
					try {
						...
						$sql2 = "SELECT `mid`, `member_id`, `member_pwd`, `member_name`, `member_type`, `member_gender`, `member_email`, `member_birthday`, `member_address`, `member_phone`, `member_picture`, `member_totalpoints`, `member_usingpoints`, `member_status`, `recommand_code` FROM member where member_trash=0 ";
