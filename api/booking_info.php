			...
			if ($result = mysqli_query($link, $sql)){
				if (mysqli_num_rows($result) > 0){
					...
					try {
						...
						$sql2 = "SELECT a.rid,a.booking_no,a.store_id,a.hid, a.reserve_date, a.reserve_time, a.mid,a.member_id, a.member_name,a.member_email, a.service_item, a.reserve_remark, a.reserve_status, a.reserve_created_at, c.nick_name  FROM reserveinfo a  ";
