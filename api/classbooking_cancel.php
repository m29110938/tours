			...
			if ($result = mysqli_query($link, $sql)){
				if (mysqli_num_rows($result) > 0){
					...
					try {
						...
						$sql2 = "SELECT rid,booking_no,store_id,pid, reserve_date, reserve_time, mid,member_id, member_name, member_email,program_person, reserve_status, reserve_created_at  FROM class_reserveinfo where rid>0 ";
						...
						if ($result2 = mysqli_query($link, $sql2)){
							if (mysqli_num_rows($result2) > 0){
								...
								$sql3="update class_reserveinfo set reserve_status=2 where rid=".$rid;
								mysqli_query($link,$sql3) or die(mysqli_error($link));

								$data["status"]="true";
								$data["code"]="0x0200";
								$data["responseMessage"]="The class booking information have been canceled!";
							}else{
								$data["status"]="false";
								$data["code"]="0x0201";
