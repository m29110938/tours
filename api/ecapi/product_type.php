			...
			if ($result = mysqli_query($link, $sql)){
				if (mysqli_num_rows($result) > 0){
					...
					try {
						...
						$sql2 = "SELECT pid,product_type,producttype_name,producttype_picture from producttype where producttype_trash=0 ";					
						$sql2 = $sql2." order by product_type, pid";
						//echo $sql2;
						//$data = "";
						if ($result2 = mysqli_query($link, $sql2)){
							if (mysqli_num_rows($result2) > 0){
								...
								$data["status"]="false";
								$data["code"]="0x0201";
								$data["responseMessage"]="This is no product type data!";									
							}
						}else{
