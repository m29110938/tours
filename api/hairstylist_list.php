			...
			if ($result = mysqli_query($link, $sql)){
				if (mysqli_num_rows($result) > 0){
					...
					try {
						...
						$sql2 = "SELECT hid,store_id,nick_name,stylist_pic,service_code,hairstylist_date FROM `hairstylist` where hid>0 and hairstylist_trash=0 ";
						...
						if ($h_id != "") {	
							$sql2 = $sql2." and hid = ".$h_id."";
						}
						if ($membersid != 0) {	
							$sql2 = $sql2." and store_id = ".$membersid."";
						}						
						$sql2 = $sql2." order by nick_name asc";
...
//echo $sql2;
						...
						if ($result2 = mysqli_query($link, $sql2)){
							if (mysqli_num_rows($result2) > 0){
								...
								$data["status"]="false";
								$data["code"]="0x0201";
								$data["responseMessage"]="This is no hairstylist data!";									
							}
						}else{
