			...
			if ($result = mysqli_query($link, $sql)){
				if (mysqli_num_rows($result) > 0){
					...
					try {
						...
						$sql2 = "SELECT a.rid, a.qid, b.questiontype_name, a.question_subject, a.question_description FROM question a inner join questiontype b on a.qid=b.qid  where a.question_trash=0 ";
						//$sql2 = $sql2." and coupon_enddate > NOW()";

						if ($question_type != "") {	
							$sql2 = $sql2." and a.qid=".$question_type."";
						}						
						$sql2 = $sql2." order by a.qid,a.rid";
