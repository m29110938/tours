			...
			if ($result = mysqli_query($link, $sql)){
				if (mysqli_num_rows($result) > 0){
					...
					try {
						...
						$sql2 = "SELECT qid,questiontype_name from questiontype where questiontype_trash=0 ";					
						$sql2 = $sql2." order by questiontype_name, qid";
						...
						if ($result2 = mysqli_query($link, $sql2)){
							if (mysqli_num_rows($result2) > 0){
								...
								$data["status"]="false";
								$data["code"]="0x0201";
								$data["responseMessage"]="This is no question type data!";									
							}
						}else{
