...
$loc_lng2 = isset($_POST['loc_lng']) ? $_POST['loc_lng'] : 0;
	...
	if (($member_id != '') && ($member_pwd != '')) {
		...
		try {
			...
			$coupon  = mysqli_real_escape_string($link,$coupon);
			...
			if ($result = mysqli_query($link, $sql)){
				if (mysqli_num_rows($result) > 0){
					...
					try {
						...
						$sql2 = "SELECT a.sid, a.store_id, a.store_type, a.store_name, a.shopping_area, a.store_phone, a.store_address, a.store_website, a.store_facebook,a.store_news,a.store_picture, a.store_latitude, a.store_longitude, a.store_status FROM store as a";
						//$sql2 = $sql2." and coupon_enddate > NOW()";
						if ($coupon != "") {	
							$sql2 = $sql2." INNER JOIN(SELECT * FROM coupon) as b ON b.coupon_storeid = a.sid";
						}
						$sql2 = $sql2." where a.store_trash=0 ";
						if ($coupon != "") {	
							$sql2 = $sql2." and b.coupon_trash=0 and b.coupon_status=1";
							$sql2 = $sql2." and b.coupon_enddate >= NOW() and b.coupon_startdate <= NOW()";
						}
						if ($shopping_area != "") {	
						...
						if ($result2 = mysqli_query($link, $sql2)){
							if (mysqli_num_rows($result2) > 0){
								...
								while($row2 = mysqli_fetch_array($result2)){
									...
									$rows[] = array("0"=> $c1 , "sid"=> $c1 , "1"=> $c2,"store_id"=> $c2, "2"=> $c3, "store_type"=> $c3,"3"=> $c4,"store_name"=> $c4, "4"=> $c5,"shopping_area"=> $c5, "5"=> $c6,"store_phone"=> $c6,"6"=> $c7,"store_address"=> $c7,"7"=> $c8,"store_website"=> $c8,"8"=> $c9,"store_facebook"=> $c9,"9"=> $c10,"store_news"=> $c10,"10"=> $c11,"store_picture"=> $c11,"11"=> $c12,"store_latitude"=> $c12,"12"=> $c13,"store_longitude"=> $c13,"13"=> $c14,"store_status"=> $c14,"14"=> $distance,"distance"=> $distance);
