...
// $using_flag = isset($_POST['using_flag']) ? $_POST['using_flag'] : '0'; // 使用狀況
			...
			if ($result = mysqli_query($link, $sql)){
				if (mysqli_num_rows($result) > 0){
					...
					try {
						...
						//exit;
                        $sql2 = "SELECT a.pid,a.mid, a.coupon_no, a.using_flag, a.using_date, a.coupon_id ,a.coupon_name, a.coupon_type, a.coupon_description, DATE_FORMAT(a.coupon_startdate, '%Y-%m-%d') as coupon_startdate,DATE_FORMAT(a.coupon_enddate, '%Y-%m-%d') as coupon_enddate, a.coupon_status, a.coupon_rule, a.coupon_discount, a.discount_amount, a.coupon_storeid, a.coupon_for, a.coupon_picture FROM `mycoupon` as a";
                        $sql2 = $sql2." INNER JOIN (SELECT * FROM coupon) as b on b.cid = a.cid";
                        $sql2 = $sql2." INNER JOIN (SELECT * FROM store) as c on c.sid = b.coupon_storeid";
                        $sql2 = $sql2.  " WHERE c.store_trash=0 and b.coupon_trash=0 and a.mycoupon_trash=0 and a.mid = $mid and c.sid='".$member_sid."'";
						$sql2 = $sql2.  " and a.pid>0 and a.coupon_type <> 8";
						// echo $sql2;
