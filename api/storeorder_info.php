			...
			if ($result = mysqli_query($link, $sql)){
				if (mysqli_num_rows($result) > 0){
					...
					try {
						...
						$sql2 = "SELECT a.oid,a.order_no,a.order_date, a.store_id, a.member_id, a.order_amount,a.coupon_no,a.discount_amount,a.pay_type,a.order_pay,a.pay_status,a.bonus_point,a.bonus_get,a.bonus_date,a.order_status,b.member_id as m_id,b.member_name FROM orderinfo a ";
