...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
				  ...
				  <div class="card-body">
				    <form action="attraction.php" method="Post" name='frm1' id='frm1' class="card">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">景點管理列表</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
				...
				//if ($act == 'Qry') {
					...
					$sql = "SELECT a.*,b.storetype_name, c.shopping_area as shoppingarea_name FROM attraction as a ";
					$sql = $sql." inner join ( select store_type,storetype_name from attraction_type) as b ON a.store_type= b.store_type ";
  ...
  <SCRIPT LANGUAGE=javascript>
	...
	function ExportLog()
	{
		document.all.downloadlog.src="attraction.php";
	}	
	function GoAddUser()
	{	
		document.getElementById("act").value = 'Add';
		document.frm1.action="addattraction.php";
	...
	{	
		...
		//alert(id);
		document.frm1.action="editattraction.php";	
		document.frm1.submit();
	}
	function GoDel(id)
	{	
		if (confirm('確定要刪除這筆資料嗎?')) {
			...
			document.getElementById("tid").value = id;
			//alert(id);
			document.frm1.action="attractiondel.php";	
			document.frm1.submit();
		}
	}	
	function Logout(){
