      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
			...
			<form action="banneradd.php" name="frm3" id="frm3" method="post">
			<input type="hidden" name="act" id="act"  value="<?php echo $act;?>"/>
              <!-- Illustrations -->
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">新增Banner</h6>
                </div>
                <div class="card-body">
				<table width="100%">
				<tr >
					...
					<td width="30%">
					  ...
					  <div class="form-group">
						...
						<div class="row align-items-center">
						  <div class="col-auto">
							<textarea id="banner_descript" name="banner_descript" rows="4" cols="50"></textarea>	
						  </div>
						</div>
					  </div>
					  <div class="form-group">
						...
						<div class="row align-items-center">
						  <div class="col-auto">
							  <input class="text-input small-input" type="date" name="banner_date" id="banner_date" value="" />
						  </div>
						</div>
					  </div>		
					  <div class="form-group">
						...
						<div class="row align-items-center">
						  <div class="col-auto">
							  <input class="text-input small-input" type="date" name="banner_enddate" id="banner_enddate" value="" />
						  </div>
						</div>
					  </div>
					  <div class="form-group">
						<label class="form-label">連結網址:</label>  <!--  col-12 -->
						<div class="row align-items-center">
						  <div class="col-auto">
							<input type="text" name="banner_link" id="banner_link" class="form-control" value="">
						  </div>
						</div>
					  </div>	
...
<?php } ?>
	...
	function Save_User(){
		...
		//alert(document.all.banner_date.value);
		//alert(document.all.banner_enddate.value);
