...
<body id="page-top">
  ...
  <div id="wrapper">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
			...
			<form action="questionadd.php" name="frm3" id="frm3" method="post">
			<input type="hidden" name="act" id="act"  value="<?php echo $act;?>"/>
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">新增問題管理資料</h6>
                </div>
                <div class="card-body">
					  <div class="form-group">
 					  ...
 					  <div class="form-group">
						...
						<div class="row align-items-center">
						  <div class="col-auto">
							<input type="text" name="question_subject" id="question_subject" class="form-control" value="">
						  </div>
						</div>
					  </div>				
					  <div class="form-group">
						...
						<div class="row align-items-center">
						  <div class="col-auto">
							<textarea id="question_description" name="question_description" rows="4" cols="50"></textarea>							
						  </div>
						</div>
					  </div>
	...
	function Save_User(){
		...
		if (!checkString(document.all.question_description,"請輸入問題說明!"))	return false;
