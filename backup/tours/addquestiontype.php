      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
			...
			<form action="questiontypeadd.php" name="frm3" id="frm3" method="post">
			<input type="hidden" name="act" id="act"  value="<?php echo $act;?>"/>
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">新增問題分類</h6>
                </div>
                <div class="card-body">
					  <!--<div class="form-group">
						...
						<div class="row align-items-center">
						  <div class="col-auto">
							<input type="text" name="typeid" id="typeid" class="form-control" value="">
						  </div>
						</div>
					  </div>		-->			
					  <div class="form-group">
						...
						<div class="row align-items-center">
						  <div class="col-auto">
							<input type="text" name="questiontype_name" id="questiontype_name" class="form-control" value="">
						  </div>
						</div>
					  </div>
