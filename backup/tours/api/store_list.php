			...
			if ($result = mysqli_query($link, $sql)){
				if (mysqli_num_rows($result) > 0){
					...
					try {
						...
						$sql2 = "SELECT `sid`, `store_id`, `store_type`, `store_name`, `shopping_area`, `store_phone`, `store_address`, `store_website`, `store_facebook`,`store_news`,`store_picture`, `store_latitude`, `store_longitude`, `store_status` FROM store where store_trash=0 ";
						//$sql2 = $sql2." and coupon_enddate > NOW()";
						if ($shopping_area != "") {	
							$sql2 = $sql2." and shopping_area=".$shopping_area."";
						}
						if ($store_type != "") {	
							$sql2 = $sql2." and store_type=".$store_type."";
						}						
						$sql2 = $sql2." order by store_latitude desc, store_type,store_id";
