...
if ($act == 'upd') {
	...
	$bonus  = mysqli_real_escape_string($link,$bonus);
			
	$sql="update systemsetting set bonus=$bonus ";
      ...
      <li class="nav-item active">
		...
		<div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
		  <div class="bg-white py-2 collapse-inner rounded">
			...
			<a class="collapse-item active" href="bonus.php">紅利點數設定</a>
			<?php } ?>
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3">
			...
			<h1 class="h5 mb-0 text-gray-800">紅利點數設定</h1>
            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">紅利點數計算公式</h6>
                </div>
                <div class="card-body">
					...
					<input type="hidden" name="act" id="act"  value=""/>
					  <div class="form-group">
						<div class="row align-items-center">
						  ...
						  <div class="col-auto">
							<input type="text" id="bonus" name="bonus" class="form-control w-12" value="<?php echo $bonus; ?>">
						  </div>
						  <div class="col-auto">
							元可回饋1點
						  </div>						  
					  ...
					  <div class="form-group">
						  ...
						  <div class="text-center">
							<?php if ($_SESSION['authority']=="1"){ ?><button type="button" class='btn btn-success ml-auto' onclick='SubmitF();'>儲存</button><?php } ?>
						  </div>							
					  </div>
					</form>
                </div>
