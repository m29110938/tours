...
<body id="page-top">
  ...
  <div id="wrapper">
					...
					<td width="40%" valign="top">
						...
						<div class="row align-items-center">
						  <div class="col-auto">
								...
								<?php
								echo "<img src='https://tyocaclass.tw/tours/genqrcode.php?tid=".$store_id."' width=512 height=512 >";
								?>								
								</div>
								<!--<center><a href="#" onclick="prepHref(this)" download>下載圖片</a> </center>-->
						  </div>
						</div>
						</div>						
	...
	function dwpng(sUrl){
		...
		//	window.open("http://127.0.0.1/tours/"+sUrl, '_self');
		//	
		//}
