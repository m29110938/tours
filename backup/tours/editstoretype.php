...
if (($_SESSION['authority']=="3")||($_SESSION['authority']=="4")){
	...
	$sql = "SELECT * FROM store_type where storetype_trash=0 and rid=$tid";
	//echo $sql;
	//exit;
          ...
          <div class="row">
			...
			<input type="hidden" name="tid" id="tid"  value="<?php echo $tid;?>"/>				  
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">編輯類別設定</h6>
                </div>
                <div class="card-body">
					  ...
					  <div class="form-group">
						...
						<div class="row align-items-center">
						  <div class="col-auto">
							<input type="text" name="storetype_name" id="storetype_name" class="form-control" value="<?php echo $storetype_name;?>">
						  </div>
						</div>
					  </div>
