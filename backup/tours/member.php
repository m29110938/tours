...
<body id="page-top">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3">
			...
			<h1 class="h5 mb-0 text-gray-800">會員管理</h1>
		...
		<?php
			...
			//	$EDate = date("Y-m-d");;
			//}			
			Save_Log($link,$_SESSION['userid'],$_SESSION['accname'],$_SESSION['loginsid'],'Member',$_SESSION['authority']);
		?>
        <!-- Begin Page Content -->
            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
				  ...
				  <div class="card-body">
				    <form action="member.php" method="Post" name='frm1' id='frm1' class="card">
						...
						<div class="col-md-6 col-lg-2">
							<div class="form-group">
								...
								<select name="member_type" id="member_type" class="form-control custom-select">
								  <option value="">--全選--</option>
								  <option value="1" <?php if ($membertype=="1") echo "selected"; ?>>一般會員</option>
								  <option value="2" <?php if ($membertype=="2") echo "selected"; ?>>特約店家</option>
								  <option value="3" <?php if ($membertype=="3") echo "selected"; ?>>特約旅行社</option>
								  <option value="4" <?php if ($membertype=="4") echo "selected"; ?>>導遊</option>
								</select>
							</div>
						</div>	
						<div class="col-md-6 col-lg-2">
            ...
            <div class="card-body">
              <div class="table-responsive">
				...
				//if ($act == 'Qry') {
					...
					if ($gender != "") {	
						$sql = $sql." and member_gender=".$gender."";
					}
					if ($staus != "") {	
						$sql = $sql." and member_status='".$staus."'";
					}					
					if ($mobile != "") {	
						$sql = $sql." and member_phone like '%".$mobile."%'";
					}
					if (trim($memberid) != "") {	
						$sql = $sql." and member_id like '%".trim($memberid)."%'";
					}
					if (trim($membername) != "") {	
					...
					if ($SDate != "") {	
						$sql = $sql." and member_created_at >= '".$SDate." 00:00:00'";
					}
					if ($EDate != "") {	
						$sql = $sql." and member_created_at <= '".$EDate." 23:59:59'";
					}			
					...
					if ($result = mysqli_query($link, $sql)){
						if (mysqli_num_rows($result) > 0){
							...
							while($row = mysqli_fetch_array($result)){
									...
									echo "    <td>".($row['member_totalpoints']-$row['member_usingpoints'])."</td>";
									echo "    <td>".$row['member_created_at']."</td>";
									...
									if (($_SESSION['authority']=="1")||($_SESSION['authority']=="2")){
										echo "    <td>";
										echo "      <a href='javascript:GoEdit(".$row['mid'].")'><i class='fa fa-edit'></i></a>";
										echo "    </td>";
									}
									if ($_SESSION['authority']=="1"){
										echo "    <td>";
										echo "  	<a href='javascript:GoDel(".$row['mid'].")'><i class='fa fa-trash'></i></a>";					
										echo "    </td>   "; 
									}
									echo "  </tr>";
							}
  ...
  <SCRIPT LANGUAGE=javascript>
	...
	function ExportLog()
	{
		document.all.downloadlog.src="member.php";
	}	
	function GoAddUser()
	{	
		document.getElementById("act").value = 'Add';
		document.frm1.action="addmember.php";
	...
	{	
		...
		//alert(id);
		document.frm1.action="editmember.php";	
		document.frm1.submit();
	}
	function GoDel(id)
	{	
		if (confirm('確定要刪除這筆資料嗎?')) {
			...
			document.getElementById("tid").value = id;
			//alert(id);
			document.frm1.action="memberdel.php";	
			document.frm1.submit();
		}
	}	
	function Logout(){
