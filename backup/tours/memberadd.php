...
//
		...
		$sql="INSERT INTO member (member_id,member_pwd,member_name,member_type,member_gender,member_email,member_birthday,member_address,member_phone,member_status,recommend_code,member_sid) VALUES ('$member_id','$member_pwd','$member_name',$member_type,$member_gender,'$member_email','$member_birthday','$member_address','$member_phone','$member_status','$recommend_code',$member_sid);";
