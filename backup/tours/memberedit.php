...
//
		...
		$sql="update member set member_id='$member_id',member_pwd='$member_pwd',member_name='$member_name',member_type=$member_type,member_gender=$member_gender,member_email='$member_email',member_address='$member_address',member_phone='$member_phone',member_status='$member_status',recommend_code='$recommend_code',member_sid=$member_sid,member_updated_at=NOW() ";
		if ($member_birthday != "") {
			$sql=$sql.",member_birthday='$member_birthday'";
		}else{
			$sql=$sql.",member_birthday=null";
		}
		$sql=$sql." where mid=$tid ;";
