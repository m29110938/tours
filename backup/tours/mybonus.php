      ...
      <li class="nav-item active">
		...
		<div id="collapseUtilities0" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
		  <div class="bg-white py-2 collapse-inner rounded">
			...
			<a class="collapse-item active" href="mybonus.php">紅利點數列表</a>
		  </div>
		</div>		  
      </li>	  
	  <?php } ?>
            ...
            <div class="card-body">
              <div class="table-responsive">
				...
				//if ($act == 'Qry') {
					...
					$sql = $sql." inner join ( select order_no,order_date,store_id,order_pay from orderinfo) b on a.order_no = b.order_no ";
					
					$sql = $sql." where a.bid>0 ";
					
					if (trim($membername) != "") {	
						$sql = $sql." and c.member_name like '%".trim($membername)."%'";
					}	
					if (trim($order_no) != "") {	
