      ...
      <li class="nav-item active">
		...
		<div id="collapseUtilities0" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
		  <div class="bg-white py-2 collapse-inner rounded">
			...
			<a class="collapse-item active" href="mycoupon.php">票券列表</a>
						...
						<div class="col-md-6 col-lg-2">
						  <div class="form-group">
							  ...
							  <div class="text-center">
								<button type="button" class='btn btn-success ml-auto' onclick='SubmitF();'>搜尋</button> &nbsp;<button type="reset" class="btn btn-info ml-auto">重設</button><!--<button type="button" class="btn btn-success ml-auto" onclick='GoAddUser()'>新增</button> &nbsp;<button type="submit" class="btn btn-primary ml-auto">匯入</button>-->
							  </div>							
						  </div>
						</div>						
					</div>					
            ...
            <div class="card-body">
              <div class="table-responsive">
				...
				//if ($act == 'Qry') {
					...
					$sql = "SELECT a.*,b.member_name, c.store_name FROM mycoupon as a ";
					$sql = $sql." inner join ( select mid,member_name from member) as b ON a.mid= b.mid ";
					$sql = $sql." inner join ( select sid,store_name from store) c on a.coupon_storeid = c.sid ";
