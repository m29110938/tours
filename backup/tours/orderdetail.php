    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item  active">
		...
		<div id="collapseUtilities2" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
		  <div class="bg-white py-2 collapse-inner rounded">
			<a class="collapse-item active" href="order.php">訂單管理</a>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
			...
			<?php
				...
				$sql = "SELECT a.*,b.store_name, c.member_id as memberid,c.member_name,d.shopping_area as shoppingarea FROM orderinfo as a ";
				$sql = $sql." inner join ( select sid,store_id,store_name,shopping_area from store) as b ON b.sid= a.store_id ";
			...
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					...
					<tr>
						<td>商店名稱:</td><td><?php echo $store_name; ?></td><td>付款方式:</td><td><?php echo $pay_type; ?></td><td>訂單贈點:</td><td>0</td>
					</tr>
					<tr>
						<td>訂單時間:</td><td><?php echo $order_date; ?></td><td>訂單金額:</td><td>NT <?php echo $order_amount; ?></td><td>&nbsp;</td><td>&nbsp;</td>
					</tr>
					<tr>
						<td>訂單編號:</td><td><?php echo $order_no; ?></td><td>實付金額:</td><td>NT <?php echo ($order_amount-$discount_amount); ?></td><td>&nbsp;</td><td>&nbsp;</td>
					</tr>
					</table>
				</div>
				<div class="card-header py-3">
				...
				<!--<div class="card-body">
					<table width="100%">
					<tr>
						<td width="10%">商品名稱:</td><td width="20%">一般商品</td><td width="10%">&nbsp;</td><td width="20%">&nbsp;</td><td width="10%">&nbsp;</td><td>&nbsp;</td>
					</tr>
					</table>
				</div>
				<div class="card-header py-3">
				...
				<div class="card-body">
					...
					<table class='table card-table table-vcenter text-nowrap'>
						...
						<tr>
							...
							<td><?php if ($order_status == 1){ ?><button type="button" class='btn btn-danger ml-auto' onclick="CancelOrder();">退款</button><?php } ?></td>
						</tr>
						</tbody>
					</table>
  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	...
	function CancelOrder()
	{
		if (confirm('確定要取消這筆訂單嗎?')) {
			...
			document.frm1.action="cancelorder.php";	
			document.frm1.submit();
		}		
	}
	function GoAccount()
	{
		self.location.replace("order.php");
	}
	function Logout(){
		//alert("登出系統!");
