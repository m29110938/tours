<?php
	...
	if ($act == 'Edit') {
		...
		$sql="update product set product_no='$product_no',product_name='$product_name',pid=$product_type,product_bonus=$product_bonus,product_stock=$product_stock,product_description='$product_description',product_status='$product_status' where rid=$tid ;";
