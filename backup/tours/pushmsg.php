...
<body id="page-top">
      ...
      <li class="nav-item active">
		...
		<div id="collapseUtilities4" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
		  <div class="bg-white py-2 collapse-inner rounded">
			...
			<a class="collapse-item active" href="pushmsg.php">推播訊息</a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
		...
		<?php
			...
			$pushmsgstatus = isset($_POST['pushmsg_status']) ? $_POST['pushmsg_status'] : '';
			$pushmsgstatus  = mysqli_real_escape_string($link,$pushmsgstatus);		
			
			$pushmessage = isset($_POST['push_message']) ? $_POST['push_message'] : '';
			$pushmessage  = mysqli_real_escape_string($link,$pushmessage);
            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
				  ...
				  <div class="card-body">
				    <form action="pushmsg.php" method="Post" name='frm1' id='frm1' class="card">
					...
					<div class="row">
						...
						<div class="col-md-6 col-lg-2">
						  <div class="form-group">
							...
							<div class="row align-items-center">
							  <div class="col-auto">
								<input type="text" id="push_message" name="push_message" class="form-control w-12" value="<?php echo $pushmessage; ?>">
							  </div>
							</div>
						  </div>	
						</div>	
						<div class="col-md-6 col-lg-2">
							<div class="form-group">
								...
								<select name="pushmsg_status" id="pushmsg_status" class="form-control custom-select">
								  <option value="">--全選--</option>
								  <option value="1" <?php if ($pushmsgstatus=="0") echo "selected"; ?>>已完成</option>
								  <option value="0" <?php if ($pushmsgstatus=="1") echo "selected"; ?>>未完成</option>
								</select>
							</div>
						</div>						
						<div class="col-md-6 col-lg-2">
            ...
            <div class="card-body">
              <div class="table-responsive">
				...
				//if ($act == 'Qry') {
					...
					$sql = "SELECT * FROM pushmsg where pushmsg_trash=0 ";

					if ($pushmsgstatus != "") {	
						$sql = $sql." and pushmsg_status=".$pushmsgstatus."";
					}
					if ($pushmessage != "") {	
						$sql = $sql." and push_message like '%".$pushmessage."%'";
					}
					if ($SDate != "") {	
						$sql = $sql." and push_date >= '".$SDate." 00:00:00'";
					}
					if ($EDate != "") {	
						$sql = $sql." and push_date <= '".$EDate." 23:59:59'";
					}			
					$sql = $sql." order by push_date desc ";
					//echo $sql;
					//exit;
					$idx = 0;
 ...
 <SCRIPT LANGUAGE=javascript>
	...
	function ExportLog()
	{
		document.all.downloadlog.src="pushmsg.php";
	}	
	function GoAddUser()
	{	
		document.getElementById("act").value = 'Add';
		document.frm1.action="addpushmsg.php";
	...
	{	
		...
		//alert(id);
		document.frm1.action="editpushmsg.php";	
		document.frm1.submit();
	}
	function GoDel(id)
	{	
		if (confirm('確定要刪除這筆資料嗎?')) {
			...
			document.getElementById("tid").value = id;
			//alert(id);
			document.frm1.action="pushmsgdel.php";	
			document.frm1.submit();
		}
	}	
	function Logout(){
