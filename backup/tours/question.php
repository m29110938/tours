...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
		...
		<div id="collapseUtilities3" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
		  <div class="bg-white py-2 collapse-inner rounded">
			<a class="collapse-item" href="questiontype.php">問題分類</a>
			<a class="collapse-item active" href="question.php">問題管理</a>
		  </div>
		</div>		  
      </li>
      <li class="nav-item">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3">
			...
			<h1 class="h5 mb-0 text-gray-800">問題管理設定</h1>
		...
		<?php
			...
			$questiontype = isset($_POST['question_type']) ? $_POST['question_type'] : '';
			$questiontype  = mysqli_real_escape_string($link,$questiontype);
			$questionsubject = isset($_POST['question_subject']) ? $_POST['question_subject'] : '';
			$questionsubject  = mysqli_real_escape_string($link,$questionsubject);
        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
				  ...
				  <div class="card-body">
				    <form action="question.php" method="Post" name='frm1' id='frm1' class="card">
						  ...
						  <div class="form-group">
							<label class="form-label">問題分類:</label>
								<select name="question_type" id="question_type" class="form-control custom-select">
								  ...
								  <?php
									$sql = "select qid,questiontype_name from questiontype where questiontype_trash=0 order by questiontype_name asc";
									
									if ($result = mysqli_query($link, $sql)){
										if (mysqli_num_rows($result) > 0){
											$selectedflag = "";
											while($row = mysqli_fetch_array($result)){
												if ($questiontype == strval($row['qid'])) {
													$selectedflag = " selected ";
												}else{
													$selectedflag = "";
												}
												echo "<option value='".$row['qid']."' ".$selectedflag." >".$row['questiontype_name']."</option>";
											}
										}
									}								
								  ?>
						...
						<div class="col-md-6 col-lg-3">
						  <div class="form-group">
							...
							<div class="row align-items-center">
							  <div class="col-auto">
								<input type="text" id="question_subject" name="question_subject" class="form-control w-12" value="<?php echo $questionsubject; ?>">
							  </div>
							</div>
						  </div>	
						</div>	
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">問題管理列表</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
				...
				//if ($act == 'Qry') {
					...
					$sql2 = "SELECT a.*,b.questiontype_name FROM question a  ";
					$sql2 = $sql2." inner join ( select qid,questiontype_name from questiontype) as b ON a.qid= b.qid ";
					$sql2 = $sql2." where question_trash=0 ";
					if ($questiontype != "") {	
						$sql2 = $sql2." and a.qid =".$questiontype."";
					}
					if ($questionsubject != "") {	
						$sql2 = $sql2." and question_subject like '%".$questionsubject."%'";
					}
			
					$sql2 = $sql2." order by qid,question_subject ";
					//echo $sql2;
					//exit;
					$idx = 0;
					if ($result2 = mysqli_query($link, $sql2)){
						if (mysqli_num_rows($result2) > 0){
							...
							while($row2 = mysqli_fetch_array($result2)){
									...
									echo "  <tr>";
									echo "    <td>".$idx."</td>";
									echo "    <td>".$row2['questiontype_name']."</td>";
									echo "    <td>".$row2['question_subject']."</td>";
									echo "    <td>".$row2['question_created_at']."</td>";
									if (($_SESSION['authority']=="1")||($_SESSION['authority']=="2")){
										echo "    <td>";
										echo "      <a href='javascript:GoEdit(".$row2['rid'].")'><i class='fa fa-edit'></i></a>";
										echo "    </td>";
									}
									if ($_SESSION['authority']=="1"){
										echo "    <td>";
										echo "  	<a href='javascript:GoDel(".$row2['rid'].")'><i class='fa fa-trash'></i></a>";					
										echo "    </td>   ";  
									}
									echo "  </tr>";
							}
  ...
  <SCRIPT LANGUAGE=javascript>
	...
	function ExportLog()
	{
		document.all.downloadlog.src="question.php";
	}	
	function GoAddUser()
	{	
		document.getElementById("act").value = 'Add';
		document.frm1.action="addquestion.php";
		//self.location.replace("addquestion.php");
	...
	{	
		...
		//alert(id);
		document.frm1.action="editquestion.php";	
		//self.location.replace("editquestion.php");	
		document.frm1.submit();
	}
	function GoDel(id)
	{	
		if (confirm('確定要刪除這筆資料嗎?')) {
			...
			document.getElementById("tid").value = id;
			//alert(id);
			document.frm1.action="questiondel.php";	
			document.frm1.submit();
		}
	}	
	function Logout(){
