      ...
      <li class="nav-item active">
		...
		<div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
		  <div class="bg-white py-2 collapse-inner rounded">
			...
			<a class="collapse-item active" href="storemember.php">店家會員</a>
			<?php if ($_SESSION['authority']!="4"){  ?>
						...
						<div class="col-md-6 col-lg-3">
						  <div class="form-group">
							  ...
							  <div class="text-center">
								<button type="button" class='btn btn-info ml-auto' onclick='SubmitF();'>搜尋</button> &nbsp;<!--<button type="button" class="btn btn-success ml-auto" onclick='GoAddUser()'>新增</button> &nbsp;<button type="submit" class="btn btn-primary ml-auto">匯入</button>-->
							  </div>							
						  </div>
						</div>						
					</div>					
