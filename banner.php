...
<body id="page-top">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
		...
		<div id="collapseUtilities4" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
		  <div class="bg-white py-2 collapse-inner rounded">
			<a class="collapse-item active" href="banner.php">Banner管理</a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
		...
		<?php
			...
			$bannersubject = isset($_POST['banner_subject']) ? $_POST['banner_subject'] : '';
			$bannersubject  = mysqli_real_escape_string($link,$bannersubject);
        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
				  ...
				  <div class="card-body">
				    <form action="banner.php" method="Post" name='frm1' id='frm1' class="card">
						...
						<div class="col-md-6 col-lg-3">
						  <div class="form-group">
							...
							<div class="row align-items-center">
							  <div class="col-auto">
								<input type="text" id="banner_subject" name="banner_subject" class="form-control w-12" value="<?php echo $bannersubject; ?>">
							  </div>
							</div>
						  </div>	
						</div>	
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Banner管理列表</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
				...
				//if ($act == 'Qry') {
					...
					$sql = "SELECT * FROM banner where banner_trash=0 ";

					if ($bannersubject != "") {	
						$sql = $sql." and banner_subject like '%".$bannersubject."%'";
					}
					if ($SDate != "") {	
					...
					$sql = $sql." order by banner_date desc ";
					//echo $sql;
					//exit;
					$idx = 0;
					if ($result = mysqli_query($link, $sql)){
						if (mysqli_num_rows($result) > 0){
							...
							while($row = mysqli_fetch_array($result)){
									...
									echo "  <tr>";
									echo "    <td>".$idx."</td>";
									echo "    <td>".$row['banner_date']."</td>";
									echo "    <td>".$row['banner_subject']."</td>";
  ...
  <SCRIPT LANGUAGE=javascript>
	...
	{	
		...
		document.frm1.action="addbanner.php";
	...
	{	
		...
		//alert(id);
		document.frm1.action="editbanner.php";	
	...
	{	
		if (confirm('確定要刪除這筆資料嗎?')) {
			...
			document.getElementById("tid").value = id;
			//alert(id);
			document.frm1.action="bannerdel.php";	
