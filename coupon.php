...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
		...
		<div id="collapseUtilities5" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
		  <div class="bg-white py-2 collapse-inner rounded">
			<a class="collapse-item active" href="coupon.php">優惠券設定</a>
			<a class="collapse-item" href="arlist.php">AR 點位設定</a>
		  </div>
		</div>		  
      </li>	  
      <li class="nav-item">
            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3">
				  ...
				  <div class="card-body">
				    <form action="coupon.php" method="Post" name='frm1' id='frm1' class="card">
					...
					<div class="row">
						<div class="col-md-6 col-lg-2">
							<div class="form-group">
								<label class="form-label">優惠券類別:</label>
								<select name="coupon_type" id="coupon_type" class="form-control custom-select">
								  ...
								  <!-- <option value="5" <?php if ($coupon_type=="5") echo " selected"; ?>>平台生日禮</option> -->
								  <option value="6" <?php if ($coupon_type=="6") echo " selected"; ?>>平台入會禮</option>
                        ...
                        <div class="col-md-6 col-lg-2">
							  <div class="form-group">
								<label class="form-label">有效日期(起)</label>
                        ...
                        <div class="col-md-6 col-lg-2">
							  <div class="form-group">
								<label class="form-label">有效日期(迄)</label>
            ...
            <div class="card-body">
              <div class="table-responsive">
				...
				//if ($act == 'Qry') {
					...
					if ($SDate != "") {	
						$sql = $sql." and coupon_enddate >= '".$SDate." 00:00:00'";
					}
					if ($EDate != "") {	
  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	...
	{	
		...
		document.frm1.action="addcoupon.php";
	...
	{	
		...
		//alert(id);
		document.frm1.action="editcoupon.php";	
	...
	{	
		if (confirm('確定要刪除這筆資料嗎?')) {
			...
			document.getElementById("tid").value = id;
			//alert(id);
			document.frm1.action="coupondel.php";	
			document.frm1.submit();
		}
	}	
	function Logout(){
