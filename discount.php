...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
		...
		<?php
			...
			//	$EDate = date("Y-m-d");;
			//}			
			Save_Log($link,$_SESSION['userid'],$_SESSION['accname'],$_SESSION['loginsid'],'Discount',$_SESSION['authority']);
		?>
        <!-- Begin Page Content -->
        <div class="container-fluid">
            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
				  ...
				  <div class="card-body">
				    <form action="discount.php" method="Post" name='frm1' id='frm1' class="card">
					...
					<div class="row">
						<div class="col-md-6 col-lg-3">
						  <div class="form-group">
							...
							<div class="row align-items-center">
							  <div class="col-auto">
								<input type="text" id="coupon_storeid" name="coupon_storeid" class="form-control w-12" value="<?php echo $coupon_storeid; ?>">
							  </div>
							</div>
						  </div>	
						</div>			
						<div class="col-md-6 col-lg-3">
						  <div class="form-group">
							...
							<div class="row align-items-center">
							  <div class="col-auto">
								<input type="text" id="coupon_id" name="coupon_id" class="form-control w-12" value="<?php echo $coupon_id; ?>">
							  </div>
							</div>
						  </div>	
						</div>
						<div class="col-md-6 col-lg-3">
						  <div class="form-group">
							...
							<div class="row align-items-center">
							  <div class="col-auto">
								<input type="text" id="coupon_name" name="coupon_name" class="form-control w-12" value="<?php echo $coupon_name; ?>">
							  </div>
							</div>
						  </div>	
						</div>						
						<div class="col-md-6 col-lg-3">
						  <div class="form-group">
							  ...
							  <div class="text-center">
								<button type="button" class='btn btn-info ml-auto' onclick='SubmitF();'>搜尋</button> &nbsp;<?php if (($_SESSION['authority']=="1")||($_SESSION['authority']=="4")){ ?><button type="button" class="btn btn-success ml-auto" onclick='GoAddUser()'>新增</button>  <?php } ?>
							  </div>							
						  </div>
						</div>						
					</div>					
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">獨家優惠列表</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
				...
				//if ($act == 'Qry') {
					...
					$sql = $sql." where a.coupon_trash=0 and coupon_type in (1,2,3)";

					if ($_SESSION['authority']=="4"){
						$sql = $sql." and b.sid=".$_SESSION['loginsid']."";
					}					
					if ($coupon_storeid != "") {	
						$sql = $sql." and b.store_name like '%".$coupon_storeid."%'";
					}
					if ($coupon_id != "") {	
						$sql = $sql." and coupon_id like '%".$coupon_id."%'";
					}
					if ($coupon_name != "") {	
						$sql = $sql." and coupon_name like '%".$coupon_name."%'";
					}
					//if ($SDate != "") {	
					...
					if ($result = mysqli_query($link, $sql)){
						if (mysqli_num_rows($result) > 0){
							...
							while($row = mysqli_fetch_array($result)){
									...
									echo "    <td>".date('Y-m-d', strtotime($row['coupon_issue_startdate']))."~".date('Y-m-d', strtotime($row['coupon_issue_enddate']))."</td>";//
									...
									if($row['coupon_type'] ==2 || $row['coupon_type']==5){
										...
										echo "    <td>".date('Y-m-d', strtotime($row['coupon_startdate']))."~".date('Y-m-d', strtotime($row['coupon_enddate']))."</td>";//
									}
									...
									if (($_SESSION['authority']=="1")||($_SESSION['authority']=="4")){
										echo "    <td>";
										echo "  	<a href='javascript:GoDel(".$row['cid'].")'><i class='fa fa-trash'></i></a>";					
										echo "    </td>   ";                      
									}
									echo "  </tr>";
							}
  ...
  <SCRIPT LANGUAGE=javascript>
	...
	function ExportLog()
	{
		document.all.downloadlog.src="discount.php";
	}	
	function GoAddUser()
	{	
		document.getElementById("act").value = 'Add';
		document.frm1.action="adddiscount.php";
	...
	{	
		...
		//alert(id);
		document.frm1.action="editdiscount.php";	
	...
	{	
		if (confirm('確定要刪除這筆資料嗎?')) {
			...
			document.getElementById("tid").value = id;
			//alert(id);
			document.frm1.action="discountdel.php";	
			document.frm1.submit();
		}
	}	
	function Logout(){
