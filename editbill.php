...
if (($_SESSION['authority']=="3")||($_SESSION['authority']=="4")){
	...
	$sql = $sql." where a.store_bill_trash=0 and a.bid=$tid ";
	// echo $sql;
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
			...
			<form action="billedit.php" name="frm3" id="frm3" method="post">
			<input type="hidden" name="act" id="act"  value="<?php echo $act;?>"/>		
			<input type="hidden" name="tid" id="tid"  value="<?php echo $tid;?>"/>				  
			<!-- <input type="hidden" name="Dfilename" id="Dfilename"  value="<?php echo $banner_picture;?>"/> -->

                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">編輯店家帳務</h6>
                </div>
                <div class="card-body">
				<table width="100%">
				<tr >
						...
						<div class="row">
							...
							<div class="col">
								<div class="form-group">
									...
									<div class="align-items-center">
									<div class="col-auto">
										<input type="text" name="register_name" id="register_name" class="form-control" value="<?=$register_name?>">
									</div>
									</div>
								</div>	
							</div>
						...
						<div class="row">
							...
							<div class="col">
								<div class="form-group">
									...
									<div class="align-items-center">
									<div class="col-auto">
										<input type="text" name="manager_name" id="manager_name" class="form-control" value="<?=$manager_name?>">
									</div>
									</div>
								</div>	
							</div>
						...
						<div class="row">
							<div class="col">
								<div class="form-group">
									...
									<div class="align-items-center">
									<div class="col-auto">
										<input type="text" name="register_address" id="register_address" class="form-control" value="<?=$register_address?>">
									</div>
									</div>
								</div>	
							</div>
						...
						<div class="row">
							<div class="col">
								<div class="form-group">
									...
									<div class="align-items-center">
									<div class="col-auto">
										<input type="text" name="bank_name" id="bank_name" class="form-control" value="<?=$bank_name?>">
									</div>
									</div>
								</div>	
							</div>
							<div class="col">
								<div class="form-group">
									...
									<div class="align-items-center">
									<div class="col-auto">
										<input type="text" name="branch_name" id="branch_name" class="form-control" value="<?=$branch_name?>">
									</div>
									</div>
								</div>	
							</div>
						...
						<div class="row">
							<div class="col">
								<div class="form-group">
									...
									<div class="align-items-center">
									<div class="col-auto">
										<input type="text" name="bank_no" id="bank_no" class="form-control" value="<?=$bank_no?>">
									</div>
									</div>
								</div>	
							</div>
							<div class="col">
								<div class="form-group">
									...
									<div class="align-items-center">
									<div class="col-auto">
										<input type="text" name="account_no" id="account_no" class="form-control" value="<?=$account_no?>">
									</div>
									</div>
								</div>	
							</div>
						...
						<div class="row">
							<div class="col">
								<div class="form-group">
									...
									<div class="align-items-center">
									<div class="col-auto">
										<input type="text" name="office_phone" id="office_phone" class="form-control" value="<?=$office_phone?>">
									</div>
									</div>
								</div>	
							</div>
						...
						<div class="row">
							<div class="col">
								<div class="form-group">
									...
									<div class="align-items-center">
									<div class="col-auto">
										<input type="text" name="bill_address" id="bill_address" class="form-control" value="<?=$bill_address?>">
									</div>
									</div>
								</div>	
							</div>
