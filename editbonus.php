	...
	if ($result = mysqli_query($link, $sql)){
		if (mysqli_num_rows($result) > 0){
			while($row = mysqli_fetch_array($result)){
				...
				$storeservice = $row['store_service'];
          ...
          <div class="row">
			...
			<input type="hidden" name="tid3" id="tid3"  value="<?php echo $tid;?>"/>
                ...
                <div class="card-body">
						  ...
						  <div class="form-group">
							...
							<div class="row align-items-center">
							  ...
							  <!--<div class="col-auto">
								<input class="text-input small-input" type="date" name="enddate" id="enddate" value="<?php //echo $enddate;?>" />
							  </div>-->							  
							</div>
						  </div>						  
                ...
                <div class="card-body">
					  ...
					  <div class="form-group">
						<input type="checkbox" name="hotel_mode" id="hotel_mode" value="2" <?php //if ($hotel_mode==2) echo " checked=true"; ?> ><label class="form-label">旅宿模式店家:</label>
						<div class="row align-items-center">
						  <div class="col-auto">
                ...
                <div class="card-body">
						  <div class="form-group">
							...
							<div class="row align-items-center">
							  <div class="col-auto">
								<input class="text-input small-input" type="date" name="contract_startdate" id="contract_startdate" value="<?php echo $contract_startdate; ?>" />
							  </div>							  
							  <div class="col-auto">
								<input class="text-input small-input" type="date" name="contract_enddate" id="contract_enddate" value="<?php echo $contract_enddate; ?>" />
							  </div>							  
							</div>
						  </div>				  
				</div>
						...
						<div class="row align-items-center">
						  <div class="col-auto">
								<select name="profit_period" id="profit_period" class="form-control custom-select">
								  <option value="">--請選擇--</option>
								  <option value="1" <?php if ($profit_period=="1") echo " selected"; ?>>以週結算</option>
								  <option value="0" <?php if ($profit_period=="0") echo " selected"; ?>>以月結算</option>
