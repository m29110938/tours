...
if (($_SESSION['authority']=="3")||($_SESSION['authority']=="4")){
	...
	$sql = "SELECT * FROM questiontype where questiontype_trash=0 and qid=$tid";
	//echo $sql;
	//exit;
	...
	if ($result = mysqli_query($link, $sql)){
		if (mysqli_num_rows($result) > 0){
			while($row = mysqli_fetch_array($result)){
				$questiontype_name = $row['questiontype_name'];
			}
		mysqli_close($link);
		}else{
				$questiontype_name = "";
...
<body id="page-top">
  ...
  <div id="wrapper">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3">
			...
			<h1 class="h5 mb-0 text-gray-800">問題分類</h1>
          <!-- Topbar Navbar -->
        ...
        <div class="container-fluid">
          ...
          <div class="row">
			...
			<form action="questiontypeedit.php" name="frm3" id="frm3" method="post">
			<input type="hidden" name="act" id="act"  value="<?php echo $act;?>"/>		
			<input type="hidden" name="tid" id="tid"  value="<?php echo $tid;?>"/>				  
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">修改問題分類</h6>
                </div>
                <div class="card-body">
					  <!--<div class="form-group">
						...
						<div class="row align-items-center">
						  <div class="col-auto">
							<input type="text" name="typeid" id="typeid" class="form-control" value="Q1">
						  </div>
						</div>
					  </div>	-->				
					  <div class="form-group">
						...
						<div class="row align-items-center">
						  <div class="col-auto">
							<input type="text" name="questiontype_name" id="questiontype_name" class="form-control" value="<?php echo $questiontype_name;?>">
						  </div>
						</div>
					  </div>
	...
	function Save_User(){
		...
		if (!checkString(document.all.questiontype_name,"請輸入問題分類!"))	return false;
	...
	function GoAccount()
	{
			self.location.replace("questiontype.php");
	}
	function Logout(){
		//alert("登出系統!");
