<?php
	...
	if ($act == 'Add') {
		...
		$sql="INSERT INTO hairservice (store_id,service_code,service_name,service_time,service_price,service_status) VALUES ($store_id,'$service_code','$service_name','$service_time','$service_price',$service_status);";
