...
if (($sid != "")&&($mid != ""))  {
	...
	$amount2  = mysqli_real_escape_string($link,$amount2);
	...
	$sql=$sql." ('$orderid',NOW(),$sid,$tour_guide,$mid,$amount2,'',0,$pay_type,$amount2,0,0,1);";
          ...
          <div class="container">
            <div class="row">
                <div class='row justify-content-center'>
					<form role="form"  name='frm1' id='frm1' method="POST" action="./jkopay/payment.php">
					...
					<input type="hidden" class="ctrl-input" name="amount2" value="<?php echo $amount2; ?>">	
