<?php
	...
	if ($act == 'Add') {
		...
		$sql="INSERT INTO product (product_no,product_name,pid,product_price,product_bonus,product_stock,product_description,product_status) VALUES ('$product_no', '$product_name', $product_type,$product_price,0,$product_stock,'$product_description','$product_status');";
