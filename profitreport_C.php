...
<![endif]-->
<link rel=Stylesheet href="css/profitreport.css">
<style>
<!--table
...
<table border=0 cellpadding=0 cellspacing=0 width=1317 style='border-collapse:
 ...
 <tr height=24 style='height:18.0pt'>
  <td height=24 width=32 style='height:18.0pt;width:48pt'></td>
 ...
 <tr height=22 style='height:16.2pt'>
  <td height=22 colspan=20 style='height:16.2pt;mso-ignore:colspan'></td>
 </tr>
 <tr height=22 style='height:16.2pt'>
...
?>
 <tr height=22 style='height:16.8pt'>
  ...
  <td class=xl93 align=right style='border-top:none'><?php echo number_format($order_pay);?></td>
  <td></td>
  <td class=xl91 align=right><?php echo 100 * $urate;?></td>
  <td class=xl91 align=right><?php echo number_format(intval($order_pay) * $urate,1); ?></td>
  <td class=xl102 align=right><?php echo number_format($bonus);?></td>
  <td class=xl91>　</td>
  <td class=xl91 align=right><?php echo number_format($sys,1);?></td>
  <td class=xl102>　</td>
  <td class=xl91>　</td>
 ...
 <?php 
	...
	//$sql="update profit set profit_pdf='profitreport.php?sid=$sid&sdate=$sdate&edate=$edate&urate=$urate' where store_id=$sid and start_date='$sdate' and end_date='$edate'";
	//mysqli_query($conn,$sql) or die(mysqli_error($conn));
...
?>				
 <tr height=31 style='mso-height-source:userset;height:23.4pt'>
  ...
  <td class=xl101 align=right><?php echo number_format($total_amountD);?></td>
  <td></td>
  <td class=xl99>　</td>
  <td class=xl99 align=right><?php echo number_format($total_amountF);?></td>
  <td class=xl106 align=right><?php echo number_format($total_amountG,1);?></td>
  <td class=xl99>　</td>
  <td class=xl99 align=right><?php echo number_format($total_amountH,1);?></td>
  <td class=xl106 align=right><?php echo number_format($total_amountI);?></td>
  <td class=xl99>　</td>
  <td class=xl107 align=right><?php echo number_format($total_amountJ);?></td>
  <td class=xl95></td>
  <td class=xl100 align=right><?php echo number_format($total_amountK);?></td>
  <td height=31 style='height:23.4pt'></td>
 </tr>
 <tr height=22 style='height:16.8pt'>
  <td height=22 colspan=20 style='height:16.8pt;mso-ignore:colspan'></td>
 </tr>
 <tr height=22 style='height:16.2pt'>
  <td height=22 colspan=20 style='height:16.2pt;mso-ignore:colspan'></td>
 </tr>
 ...
 <tr height=44 style='mso-height-source:userset;height:33.0pt'>
  ...
  <td colspan=2 class=xl76><?php echo number_format($total_amountJ - $total_amountK) ;?></td>
  <td class=xl74 colspan=3 style='mso-ignore:colspan'><span
 ...
 <tr height=22 style='height:16.8pt'>
  ...
  <td colspan=9 rowspan=12 height=276 width=501 style='mso-ignore:colspan-rowspan;
...
">
 ...
 <![endif]>
    ...
    <script type="text/javascript">
	  ...
	  function writepdf()
	  {	  
    var store_name = document.getElementsByClassName("xl110")[0].innerText.substr(7);
    var nowdate = document.getElementsByClassName("xl111")[1].innerText.substr(7);
