<?php
	...
	if ($act == 'Edit') {
		...
		$sql="update question set qid=$question_type,question_subject='$question_subject',question_description='$question_description' where rid=$tid ;";
