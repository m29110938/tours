...
<body id="page-top">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
		...
		<div id="collapseUtilities3" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
		  <div class="bg-white py-2 collapse-inner rounded">
			<a class="collapse-item active" href="questiontype.php">問題分類</a>
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3">
			...
			<h1 class="h5 mb-0 text-gray-800">問題分類設定</h1>
        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
				  ...
				  <div class="card-body">
				    <form action="questiontype.php" method="Post" name='frm1' id='frm1' class="card">
						...
						<div class="col-md-6 col-lg-3">
						  <div class="form-group">
							...
							<div class="row align-items-center">
							  <div class="col-auto">
								<input type="text" id="question_type" name="question_type" class="form-control w-12" value="<?php echo $questiontype; ?>">
							  </div>
							</div>
						  </div>	
						</div>	
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">問題分類列表</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
				...
				//if ($act == 'Qry') {
					...
					$sql = "SELECT * FROM questiontype where questiontype_trash=0 ";

					if ($questiontype != "") {	
						$sql = $sql." and questiontype_name like '%".$questiontype."%'";
					}
			
					$sql = $sql." order by questiontype_name asc ";
					//echo $sql;
					//exit;
					$idx = 0;
					if ($result = mysqli_query($link, $sql)){
						if (mysqli_num_rows($result) > 0){
							...
							while($row = mysqli_fetch_array($result)){
									...
									echo "  <tr>";
									echo "    <td>".$idx."</td>";
									echo "    <td>".$row['questiontype_name']."</td>";
									echo "    <td>".$row['questiontype_created_at']."</td>";
									if (($_SESSION['authority']=="1")||($_SESSION['authority']=="2")){
										echo "    <td>";
										echo "      <a href='javascript:GoEdit(".$row['qid'].")'><i class='fa fa-edit'></i></a>";
										echo "    </td>";
									}
									if ($_SESSION['authority']=="1"){
										echo "    <td>";
										echo "  	<a href='javascript:GoDel(".$row['qid'].")'><i class='fa fa-trash'></i></a>";					
										echo "    </td>   ";   
									}
									echo "  </tr>";
							}
  ...
  <SCRIPT LANGUAGE=javascript>
	...
	{	
		...
		document.frm1.action="addquestiontype.php";
		//self.location.replace("addquestiontype.php");
	...
	{	
		...
		//alert(id);
		document.frm1.action="editquestiontype.php";	
		//self.location.replace("editquestiontype.php");	
		document.frm1.submit();
	}
	function GoDel(id)
	{	
		if (confirm('確定要刪除這筆資料嗎?')) {
			...
			document.getElementById("tid").value = id;
			//alert(id);
			document.frm1.action="questiontypedel.php";	
			document.frm1.submit();
		}
	}	
	function Logout(){
