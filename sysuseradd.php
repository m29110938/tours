<?php
	...
	if ($act == 'Add') {
		...
		$sql="INSERT INTO sysuser (user_id,group_id,user_name,user_pwd,user_mobile) VALUES ('$user_id',$group_id,'$user_name','$user_pwd','$user_mobile');";
